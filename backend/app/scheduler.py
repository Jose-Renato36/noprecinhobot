...
O APScheduler sobe junto com a API e dispara a coleta a cada
`SCRAPE_INTERVAL_MINUTES`. Com `SCHEDULER_ENABLED=false` ele não sobe, e a
coleta só acontece pelos botões do painel.
"""
